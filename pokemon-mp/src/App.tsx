    ...
    <div className={styles.app}>
      ...
      <main className={styles.main}>
        {loading ? (
          ...
          <Routes>
            <Route path="/" element={<List pokemons={pokemons} />} />
            <Route path="/gallery" element={<Gallery pokemons={pokemons} />} />
            <Route path="/pokemon/:idOrName" element={<Detail pokemons={pokemons} />} />
          </Routes>
        )}
      </main>
